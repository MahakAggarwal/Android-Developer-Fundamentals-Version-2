...
/* FIXME - can try another way for saved instance state get the title, description, image, info from the Sports arrayList in savedInstanceState and save in different variables; outState put them in different arrays; on restoration, create method to initialize those values and update adapter */
